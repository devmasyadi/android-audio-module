package com.androidmoduleexample.audiomoduleexample.ui.recentPlayed
...
import com.androidmoduleexample.audiomoduleexample.databinding.FragmentRecentPlayedBinding
...
class RecentPlayedFragment : Fragment() {
    ...
    private lateinit var binding: FragmentRecentPlayedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRecentPlayedBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        audioViewModel.listAudioRecentPlayed().observe(requireActivity()) { resource ->
            when (resource) {
                is Resource.Error -> {}
